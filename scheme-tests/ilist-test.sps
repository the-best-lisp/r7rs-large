;; Note: Fails on Gauche, Kawa, Larceny as equal? does not check compound objects, especially records

(import (scheme base) 
        (scheme ilist) (scheme write)
...
(test-group "ilists"
            ...
            (test-group "ilists/searching"
                        ...
                        (test-equal #t (ievery < (iq 1 2 3) (iq 4 5 6)))
            ...
            (test-group "ilists/alists"
                        (define e (iq (a 1) (b 2) (c 3))) (test-equal (iq a 1) (iassq 'a e))
