...
;; Note:
;; As most implementations provide SRFI-1 already, these functions are 
;; merely reexported if available.
;; Otherwise, the reference implementation is used.
  ...
  (cond-expand
    (kawa
      ...
      (begin
        ...
        (define (list= = . lists) ;; TODO: REMOVE WHEN CORRECTED IN DIST
    ...
    (else ; no SRFI 1 found, so use definitions below
      ...
      (begin
        ...
        (define-syntax receive ; from SRFI-8 (c) John David Stone, 1999
          (syntax-rules ()
        ...
        (define (alist-copy alist)
          (map-in-order (lambda (elt) (cons (car elt) (cdr elt)))
                        alist))
